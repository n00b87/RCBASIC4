...
rc_getMeshFrameCount( GETMESHFRAMECOUNT_MESH_ID )
...
rc_setActorWorldTransform( SETACTORWORLDTRANSFORM_ACTOR,  SETACTORWORLDTRANSFORM_MA )
...
rc_getActorFriction( GETACTORFRICTION_ACTOR )
rc_setActorFriction( SETACTORFRICTION_ACTOR,  SETACTORFRICTION_FRICTION )
rc_actorHasAniFriction( ACTORHASANIFRICTION_ACTOR )
...
rc_getActorConstraintRefCount( GETACTORCONSTRAINTREFCOUNT_ACTOR )
rc_getActorRestitution( GETACTORRESTITUTION_ACTOR )
rc_setActorRestitution( SETACTORRESTITUTION_ACTOR,  SETACTORRESTITUTION_REST )
rc_getActorCcdMotionThreshold( GETACTORCCDMOTIONTHRESHOLD_ACTOR )
rc_getActorCCDSquareMotionThreshold( GETACTORCCDSQUAREMOTIONTHRESHOLD_ACTOR )
rc_getActorCCDSweepRadius( GETACTORCCDSWEEPRADIUS_ACTOR )
...
rc_getActorContactDamping( GETACTORCONTACTDAMPING_ACTOR )
rc_getActorContactStiffness( GETACTORCONTACTSTIFFNESS_ACTOR )
...
rc_getCompositeChildTransform( GETCOMPOSITECHILDTRANSFORM_ACTOR,  GETCOMPOSITECHILDTRANSFORM_CHILD_INDEX,  GETCOMPOSITECHILDTRANSFORM_T_MATRIX )
rc_getCompositeAABB( GETCOMPOSITEAABB_ACTOR,  GETCOMPOSITEAABB_T_MATRIX,  &GETCOMPOSITEAABB_MIN_X,  &GETCOMPOSITEAABB_MIN_Y,  &GETCOMPOSITEAABB_MIN_Z,  &GETCOMPOSITEAABB_MAX_X,  &GETCOMPOSITEAABB_MAX_Y,  &GETCOMPOSITEAABB_MAX_Z )
...
rc_getCompositeUpdateRevision( GETCOMPOSITEUPDATEREVISION_ACTOR )
rc_addVehicleWheel( ADDVEHICLEWHEEL_ACTOR,  ADDVEHICLEWHEEL_WHEEL_ACTOR,  ADDVEHICLEWHEEL_IS_FRONT_WHEEL )
...
rc_getVehicleCurrentSpeed( GETVEHICLECURRENTSPEED_ACTOR )
rc_getWheelCount( GETWHEELCOUNT_ACTOR )
rc_getVehicleChassisWorldTransform( GETVEHICLECHASSISWORLDTRANSFORM_ACTOR,  GETVEHICLECHASSISWORLDTRANSFORM_T_MATRIX )
rc_getWheelSteeringValue( GETWHEELSTEERINGVALUE_ACTOR,  GETWHEELSTEERINGVALUE_WHEEL )
...
rc_getWheelSuspensionLength( GETWHEELSUSPENSIONLENGTH_ACTOR,  GETWHEELSUSPENSIONLENGTH_WHEEL )
rc_getWheelMaxSuspensionTravel( GETWHEELMAXSUSPENSIONTRAVEL_ACTOR,  GETWHEELMAXSUSPENSIONTRAVEL_WHEEL )
rc_getWheelRadius( GETWHEELRADIUS_ACTOR,  GETWHEELRADIUS_WHEEL )
rc_getWheelSuspensionStiffness( GETWHEELSUSPENSIONSTIFFNESS_ACTOR,  GETWHEELSUSPENSIONSTIFFNESS_WHEEL )
rc_getWheelDampingCompression( GETWHEELDAMPINGCOMPRESSION_ACTOR,  GETWHEELDAMPINGCOMPRESSION_WHEEL )
rc_getWheelDampingRelaxation( GETWHEELDAMPINGRELAXATION_ACTOR,  GETWHEELDAMPINGRELAXATION_WHEEL )
rc_getWheelFrictionSlip( GETWHEELFRICTIONSLIP_ACTOR,  GETWHEELFRICTIONSLIP_WHEEL )
rc_getWheelRotation( GETWHEELROTATION_ACTOR,  GETWHEELROTATION_WHEEL )
rc_getWheelRotationDelta( GETWHEELROTATIONDELTA_ACTOR,  GETWHEELROTATIONDELTA_WHEEL )
rc_getWheelRollInfluence( GETWHEELROLLINFLUENCE_ACTOR,  GETWHEELROLLINFLUENCE_WHEEL )
rc_getWheelEngineForce( GETWHEELENGINEFORCE_ACTOR,  GETWHEELENGINEFORCE_WHEEL )
rc_getWheelBrake( GETWHEELBRAKE_ACTOR,  GETWHEELBRAKE_WHEEL )
rc_wheelIsFront( WHEELISFRONT_ACTOR,  WHEELISFRONT_WHEEL )
rc_getWheelInverseContactSuspension( GETWHEELINVERSECONTACTSUSPENSION_ACTOR,  GETWHEELINVERSECONTACTSUSPENSION_WHEEL )
rc_getWheelSuspensionVelocity( GETWHEELSUSPENSIONVELOCITY_ACTOR,  GETWHEELSUSPENSIONVELOCITY_WHEEL )
