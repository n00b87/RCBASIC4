...
Sub GetActorTurnVelocity( actor, ByRef x, ByRef y, ByRef z )
Sub SetActorTurnVelocity( actor, x, y, z )
Function GetActorFriction( actor )
Sub SetActorFriction( actor, friction )
Function ActorHasAniFriction( actor )
Sub GetActorAniFriction( actor, ByRef x, ByRef y, ByRef z )
Sub SetActorAniFriction( actor, x, y, z )
Function GetActorRollingFriction( actor )
Sub SetActorRollingFriction( actor, friction )
Function GetActorSpinningFriction( actor )
Sub SetActorSpinningFriction( actor, friction )
Function GetActorContactProcessingThreshold( actor )
Sub SetActorContactProcessingThreshold( actor, cpt )
Function GetActorHitFraction( actor )
Sub SetActorHitFraction( actor, hit_fraction )
Sub GetActorInterpolationAngularVelocity( actor, ByRef x, ByRef y, ByRef z )
Sub SetActorInterpolationAngularVelocity( actor, x, y, z )
Sub GetActorInterpolationLinearVelocity( actor, ByRef x, ByRef y, ByRef z )
Sub SetActorInterpolationLinearVelocity( actor, x, y, z )
Function GetActorConstraintRefCount( actor )
Function GetActorRestitution( actor )
Sub SetActorRestitution( actor, rest )
Function GetActorCcdMotionThreshold( actor )
Function GetActorCCDSquareMotionThreshold( actor )
Function GetActorCCDSweepRadius( actor )
Sub SetActorCCD( actor, m_threshold, radius )
Sub SetActorContactStiffnessAndDamping( actor, stiffness, damping )
Function GetActorContactDamping( actor )
Function GetActorContactStiffness( actor )
Sub GetActorPushVelocity( actor, ByRef x, ByRef y, ByRef z )
Sub GetActorPushVelocityInLocalPoint( actor, rel_x, rel_y, rel_z, ByRef x, ByRef y, ByRef z )
Sub SetActorPushVelocity( actor, x, y, z )
