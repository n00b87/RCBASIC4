...
void init_embedded_functions()
{
	...
	add_embedded_arg("c_num", ID_TYPE_NUM);
	embed_function("SetCanvasBackgroundRender", ID_TYPE_SUB);
	add_embedded_arg("c_num", ID_TYPE_NUM);
	add_embedded_arg("flag", ID_TYPE_NUM);
	...
	add_embedded_arg("uv_data", ID_TYPE_BYREF_NUM);
	add_embedded_arg("index_data", ID_TYPE_BYREF_NUM);
	embed_function("GetMeshFrameCount", ID_TYPE_FN_NUM);
	add_embedded_arg("mesh_id", ID_TYPE_NUM);
	...
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("SetActorTransform", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("mA", ID_TYPE_NUM);
	...
	add_embedded_arg("mesh", ID_TYPE_NUM);
	add_embedded_arg("mass", ID_TYPE_NUM);
	embed_function("GetActorTurnVelocity", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("x", ID_TYPE_BYREF_NUM);
	add_embedded_arg("y", ID_TYPE_BYREF_NUM);
	add_embedded_arg("z", ID_TYPE_BYREF_NUM);
	embed_function("SetActorTurnVelocity", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("x", ID_TYPE_NUM);
	add_embedded_arg("y", ID_TYPE_NUM);
	add_embedded_arg("z", ID_TYPE_NUM);
	embed_function("GetActorFriction", ID_TYPE_FN_NUM);
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("SetActorFriction", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("friction", ID_TYPE_NUM);
	embed_function("ActorHasAniFriction", ID_TYPE_FN_NUM);
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("GetActorAniFriction", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("x", ID_TYPE_BYREF_NUM);
	add_embedded_arg("y", ID_TYPE_BYREF_NUM);
	add_embedded_arg("z", ID_TYPE_BYREF_NUM);
	embed_function("SetActorAniFriction", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("x", ID_TYPE_NUM);
	add_embedded_arg("y", ID_TYPE_NUM);
	add_embedded_arg("z", ID_TYPE_NUM);
	embed_function("GetActorRollingFriction", ID_TYPE_FN_NUM);
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("SetActorRollingFriction", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("friction", ID_TYPE_NUM);
	embed_function("GetActorSpinningFriction", ID_TYPE_FN_NUM);
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("SetActorSpinningFriction", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("friction", ID_TYPE_NUM);
	embed_function("GetActorContactProcessingThreshold", ID_TYPE_FN_NUM);
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("SetActorContactProcessingThreshold", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("cpt", ID_TYPE_NUM);
	embed_function("GetActorHitFraction", ID_TYPE_FN_NUM);
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("SetActorHitFraction", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("hit_fraction", ID_TYPE_NUM);
	embed_function("GetActorInterpolationAngularVelocity", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("x", ID_TYPE_BYREF_NUM);
	add_embedded_arg("y", ID_TYPE_BYREF_NUM);
	add_embedded_arg("z", ID_TYPE_BYREF_NUM);
	embed_function("SetActorInterpolationAngularVelocity", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("x", ID_TYPE_NUM);
	add_embedded_arg("y", ID_TYPE_NUM);
	add_embedded_arg("z", ID_TYPE_NUM);
	embed_function("GetActorInterpolationLinearVelocity", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("x", ID_TYPE_BYREF_NUM);
	add_embedded_arg("y", ID_TYPE_BYREF_NUM);
	add_embedded_arg("z", ID_TYPE_BYREF_NUM);
	embed_function("SetActorInterpolationLinearVelocity", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("x", ID_TYPE_NUM);
	add_embedded_arg("y", ID_TYPE_NUM);
	add_embedded_arg("z", ID_TYPE_NUM);
	embed_function("GetActorConstraintRefCount", ID_TYPE_FN_NUM);
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("GetActorRestitution", ID_TYPE_FN_NUM);
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("SetActorRestitution", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("rest", ID_TYPE_NUM);
	embed_function("GetActorCcdMotionThreshold", ID_TYPE_FN_NUM);
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("GetActorCCDSquareMotionThreshold", ID_TYPE_FN_NUM);
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("GetActorCCDSweepRadius", ID_TYPE_FN_NUM);
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("SetActorCCD", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("m_threshold", ID_TYPE_NUM);
	add_embedded_arg("radius", ID_TYPE_NUM);
	embed_function("SetActorContactStiffnessAndDamping", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("stiffness", ID_TYPE_NUM);
	add_embedded_arg("damping", ID_TYPE_NUM);
	embed_function("GetActorContactDamping", ID_TYPE_FN_NUM);
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("GetActorContactStiffness", ID_TYPE_FN_NUM);
	add_embedded_arg("actor", ID_TYPE_NUM);
	embed_function("GetActorPushVelocity", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("x", ID_TYPE_BYREF_NUM);
	add_embedded_arg("y", ID_TYPE_BYREF_NUM);
	add_embedded_arg("z", ID_TYPE_BYREF_NUM);
	embed_function("GetActorPushVelocityInLocalPoint", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("rel_x", ID_TYPE_NUM);
	add_embedded_arg("rel_y", ID_TYPE_NUM);
	add_embedded_arg("rel_z", ID_TYPE_NUM);
	...
	add_embedded_arg("y", ID_TYPE_BYREF_NUM);
	add_embedded_arg("z", ID_TYPE_BYREF_NUM);
	embed_function("SetActorPushVelocity", ID_TYPE_SUB);
	add_embedded_arg("actor", ID_TYPE_NUM);
	add_embedded_arg("x", ID_TYPE_NUM);
	add_embedded_arg("y", ID_TYPE_NUM);
	add_embedded_arg("z", ID_TYPE_NUM);
