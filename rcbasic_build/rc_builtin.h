...
void init_embedded_functions()
{
	...
	embed_function("AddSteamAchievement", ID_TYPE_SUB);
	add_embedded_arg("ach_id$", ID_TYPE_STR);
	add_embedded_arg("ach_name$", ID_TYPE_STR);
	embed_function("ClearSteamAchievements", ID_TYPE_SUB);
	embed_function("FinalizeSteamAchievements", ID_TYPE_SUB);
	embed_function("TriggerSteamAchievement", ID_TYPE_FN_NUM);
	add_embedded_arg("ach_name$", ID_TYPE_STR);
