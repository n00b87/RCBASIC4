...
#define FN_LoadVideo 359
#define LOADVIDEO_VID$ str_var[0].sref[0].value[ str_var[0].byref_offset ]
#define FN_PlayVideo 360
#define PLAYVIDEO_VLOOPS num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_PauseVideo 361
#define FN_StopVideo 362
#define FN_SetVideoPosition 363
#define SETVIDEOPOSITION_POS num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_ResumeVideo 364
#define FN_GetVideoPosition 365
#define FN_DeleteVideo 366
#define FN_VideoIsPlaying 367
#define FN_VideoEnd 368
#define FN_GetVideoStats 369
...
#define FN_SetVideoDrawRect 370
...
#define FN_GetVideoDrawRect 371
...
#define FN_Android_GetExternalStoragePath$ 383
#define FN_Android_GetExternalStorageState 384
#define FN_Android_GetInternalStoragePath$ 385
#define FN_Android_JNI_Message$ 386
#define ANDROID_JNI_MESSAGE$_ARG$ str_var[0].sref[0].value[ str_var[0].byref_offset ]
#define FN_Runtime_Utility_Message$ 387
#define RUNTIME_UTILITY_MESSAGE$_ARG$ str_var[0].sref[0].value[ str_var[0].byref_offset ]
#define FN_GetDesktopDisplayMode 388
...
#define FN_Runtime$ 394
#define FN_NumCPUs 395
#define FN_SystemRam 396
#define FN_GetGPUInfo$ 397
#define FN_Steam_AddAchievement 398
...
#define FN_Steam_ClearAchievements 399
#define FN_Steam_FinalizeAchievements 400
#define FN_Steam_TriggerAchievement 401
#define STEAM_TRIGGERACHIEVEMENT_ACH_NAME$ str_var[0].sref[0].value[ str_var[0].byref_offset ]
#define FN_Steam_GetID$ 402
#define FN_DimMatrix 403
...
#define FN_InsertMatrixColumns 408
...
#define FN_InsertMatrixRows 409
...
#define FN_DeleteMatrixColumns 412
...
#define FN_DeleteMatrixRows 413
...
#define FN_FillMatrixColumns 418
...
#define FN_CopyMatrixColumns 420
...
#define FN_SetIdentityMatrix 422
...
#define FN_MatrixFromBuffer 428
...
#define FN_BufferFromMatrix 429
...
#define FN_ScalarMatrixColumns 434
...
#define FN_ScalarMatrixRows 435
...
#define FN_SwapMatrixColumn 440
...
#define FN_IncrementMatrixRows 446
...
#define FN_IncrementMatrixColumns 447
...
#define FN_JoinMatrixColumns 449
...
#define FN_SetMatrixTranslation 451
...
#define FN_SetMatrixRotation 452
...
#define FN_GetMatrixTranslation 454
...
#define FN_GetMatrixRotation 455
...
#define FN_GetClipboardText$ 457
#define FN_SetClipboardText 458
#define SETCLIPBOARDTEXT_TXT$ str_var[0].sref[0].value[ str_var[0].byref_offset ]
#define FN_HasClipboardText 459
#define FN_ReadInput_Start 460
#define FN_ReadInput_Stop 461
#define FN_ReadInput_GetText$ 462
#define FN_ReadInput_SetText 463
#define READINPUT_SETTEXT_TXT$ str_var[0].sref[0].value[ str_var[0].byref_offset ]
#define FN_ReadInput_ToggleBackspace 464
#define READINPUT_TOGGLEBACKSPACE_FLAG num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_CreateSprite 465
...
#define FN_GetSpritePosition 469
...
#define FN_GetSpriteAnimationFrame 500
...
#define FN_SetSpriteAnimationLength 501
...
#define FN_GetSpriteAnimationLength 502
...
#define FN_SetSpriteAnimationSpeed 503
...
#define FN_GetSpriteAnimationSpeed 504
...
#define FN_SetSpriteAnimation 505
...
#define FN_setSpriteLinearVelocity 512
...
#define FN_getSpriteLinearVelocity 513
...
#define FN_setSpriteAngularVelocity 514
...
#define FN_applySpriteCentralForce 517
...
#define FN_applySpriteTorque 518
...
#define FN_applySpriteLinearImpulse 519
...
#define FN_applySpriteAngularImpulse 520
...
#define FN_getSpriteWorldVector 524
...
#define FN_getSpriteLocalPoint 525
...
#define FN_getSpriteLocalVector 526
...
#define FN_getSpriteLinearVelocityFromLocalPoint 527
...
#define FN_getSpriteLinearVelocityFromWorldPoint 528
...
#define FN_SetWorld2DTimeStep 554
#define SETWORLD2DTIMESTEP_TS num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetWorld2DVelocityIterations 555
#define SETWORLD2DVELOCITYITERATIONS_V num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetWorld2DPositionIterations 556
#define SETWORLD2DPOSITIONITERATIONS_P num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetWorld2DTimeStep 557
#define FN_GetWorld2DVelocityIterations 558
#define FN_GetWorld2DPositionIterations 559
#define FN_SetWorld2DAutoClearForces 560
#define SETWORLD2DAUTOCLEARFORCES_FLAG num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetWorld2DAutoClearForces 561
#define FN_CastRay2D 562
...
#define FN_GetSpriteBoxSize 570
...
#define FN_SetSpriteChainLoop 572
...
#define FN_SetSpritePolygon 573
...
#define FN_SetSpriteShapeOffset 574
...
#define FN_GetSpriteShapeOffset 575
...
#define FN_createDistanceJoint 576
...
#define FN_createFrictionJoint 577
...
#define FN_createMotorJoint 579
...
#define FN_createPrismaticJoint 580
...
#define FN_createPulleyJoint 581
...
#define FN_createRevoluteJoint 582
...
#define FN_createWheelJoint 584
...
#define FN_getJointWorldAnchorA 585
...
#define FN_getJointWorldAnchorB 586
...
#define FN_getJointReactionForce 587
...
#define FN_getJointReactionTorque 588
...
#define FN_getJointLocalAnchorA 589
...
#define FN_getJointLocalAnchorB 590
...
#define FN_getJointLinearOffset 611
...
#define FN_setJointAngularOffset 612
...
#define FN_setJointMotorSpeed 625
...
#define FN_setJointMaxMotorTorque 630
...
#define FN_getJointGroundAnchorA 633
...
#define FN_getJointGroundAnchorB 634
...
#define FN_SetTileAnimationLength 646
...
#define FN_GetTileAnimationLength 647
...
#define FN_SetTileAnimationFrame 648
...
#define FN_GetTileAnimationFrame 649
...
#define FN_SetTileAnimationSpeed 650
...
#define FN_GetTileAnimationSpeed 651
...
#define FN_LoadMeshFromArchive 667
...
#define FN_CreateCylinderMesh 674
...
#define FN_CreateVolumeLightMesh 675
...
#define FN_GetMeshBoundingBox 678
...
#define FN_SetActorPosition 691
...
#define FN_TranslateActorLocal 692
...
#define FN_TranslateActorWorld 693
...
#define FN_GetActorPosition 694
...
#define FN_SetActorRotation 698
...
#define FN_GetActorRotation 700
...
#define FN_SetActorAnimation 710
...
#define FN_SetActorAnimationSpeed 711
...
#define FN_SetActorAnimationFrames 712
...
#define FN_GetActorAnimationStartFrame 715
...
#define FN_GetActorAnimationEndFrame 716
...
#define FN_SetActorMD2AnimationByName 722
...
#define FN_DeleteActorAnimation 723
...
#define FN_setActorMassProperties 739
...
#define FN_getActorLinearFactor 740
...
#define FN_setActorLinearFactor 741
...
#define FN_applyActorCentralForceLocal 744
...
#define FN_applyActorCentralForceWorld 745
...
#define FN_getActorTotalForce 746
...
#define FN_getActorTotalTorque 747
...
#define FN_getActorInverseInertiaDiagLocal 748
...
#define FN_setActorInverseInertiaDiagLocal 749
...
#define FN_setActorSleepThresholds 750
...
#define FN_applyActorTorqueLocal 751
...
#define FN_applyActorTorqueWorld 752
...
#define FN_applyActorForceLocal 753
...
#define FN_applyActorForceWorld 754
...
#define FN_applyActorCentralImpulseLocal 755
...
#define FN_applyActorCentralImpulseWorld 756
...
#define FN_applyActorTorqueImpulseLocal 757
...
#define FN_applyActorTorqueImpulseWorld 758
...
#define FN_applyActorImpulseLocal 759
...
#define FN_applyActorImpulseWorld 760
...
#define FN_getActorRotationQ 764
...
#define FN_getActorLinearVelocityWorld 765
...
#define FN_getActorAngularVelocityWorld 766
...
#define FN_setActorLinearVelocityLocal 767
...
#define FN_setActorLinearVelocityWorld 768
...
#define FN_setActorAngularVelocityLocal 769
...
#define FN_setActorAngularVelocityWorld 770
...
#define FN_getActorVelocityInLocalPoint 771
...
#define FN_getActorLinearVelocityLocal 772
...
#define FN_getActorAngularVelocityLocal 773
...
#define FN_computeActorImpulseDenominator 775
...
#define FN_computeActorAngularImpulseDenominator 776
...
#define FN_setActorAngularFactor 777
...
#define FN_getActorAngularFactor 778
...
#define FN_computeActorGyroImpulseLocal 779
...
#define FN_computeActorGyroImpulseWorld 780
...
#define FN_getActorLocalInertia 781
...
#define FN_SetActorSleepState 782
...
#define FN_createPointConstraint 786
...
#define FN_createPointConstraintEx 787
...
#define FN_createHingeConstraint 790
...
#define FN_createHingeConstraintEx 791
...
#define FN_createSlideConstraint 792
...
#define FN_createSlideConstraintEx 793
...
#define FN_createConeConstraint 794
...
#define FN_createConeConstraintEx 795
...
#define FN_getConstraintFrameOffsetB 798
...
#define FN_useConstraintFrameOffset 799
...
#define FN_getConstraintBFrame 804
...
#define FN_setConstraintBreakingImpulseThreshold 806
...
#define FN_setConstraintFrames 807
...
#define FN_setConeFixThresh 839
...
#define FN_setSlideDampingDirLin 872
...
#define FN_setSlideDampingLimAng 873
...
#define FN_setSlideDampingLimLin 874
...
#define FN_setSlideDampingOrthoAng 875
...
#define FN_setSlideDampingOrthoLin 876
...
#define FN_setSlideLowerAngLimit 877
...
#define FN_setSlideLowerLinLimit 878
...
#define FN_setSlideRestitutionDirAng 879
...
#define FN_setSlideRestitutionDirLin 880
...
#define FN_setSlideRestitutionLimAng 881
...
#define FN_setSlideRestitutionLimLin 882
...
#define FN_setSlideRestitutionOrthoAng 883
...
#define FN_setSlideRestitutionOrthoLin 884
...
#define FN_setSlideSoftnessDirAng 885
...
#define FN_setSlideSoftnessDirLin 886
...
#define FN_setSlideSoftnessLimAng 887
...
#define FN_setSlideSoftnessLimLin 888
...
#define FN_setSlideSoftnessOrthoAng 889
...
#define FN_setSlideSoftnessOrthoLin 890
...
#define FN_setSlideUpperAngLimit 891
...
#define FN_setSlideUpperLinLimit 892
...
#define FN_GetCameraPosition 895
...
#define FN_SetCameraRotation 897
...
#define FN_GetCameraRotation 898
...
#define FN_RemoveSceneSky 914
#define FN_SetWorld3DMaxSubSteps 915
#define SETWORLD3DMAXSUBSTEPS_STEPS num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetWorld3DTimeStep 916
#define SETWORLD3DTIMESTEP_TS num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetWorld3DMaxSubSteps 917
#define FN_GetWorld3DTimeStep 918
#define FN_SetSceneFog 919
...
#define FN_getParticleDirection 929
...
#define FN_useParticleEveryMeshVertex 930
...
#define FN_setMinParticlesPerSecond 937
...
#define FN_getParticleMinStartSize 952
...
#define FN_setParticleMaxStartSize 953
...
#define FN_getParticleMaxStartSize 954
...
#define FN_setParticleCenter 955
...
#define FN_getParticleCenter 956
...
#define FN_setParticleRadius 957
...
#define FN_setParticleNormal 963
...
#define FN_getParticleNormal 964
...
#define FN_setParticleLength 965
...
#define FN_setLightShadowCast 975
...
#define FN_SetLightAmbientColor 976
...
#define FN_GetLightAttenuation 979
...
#define FN_SetLightDiffuseColor 980
...
#define FN_GetTerrainPatchLOD 991
...
#define FN_GetTerrainHeight 992
...
#define FN_GetTerrainCenter 993
...
#define FN_SetTerrainLODDistance 994
...
#define FN_ScaleTerrainTexture 995
...
#define FN_SetTerrainCameraMovementDelta 996
...
#define FN_SetTerrainCameraRotationDelta 997
...
#define FN_SetTerrainPatchLOD 998
...
#define FN_SetProjectorTarget 999
...
#define FN_GetProjectorTarget 1000
...
#define FN_SetProjectorFOV 1001
...
#define FN_getActorMaterial 1006
...
#define FN_copyActorMaterial 1007
...
#define FN_setMaterialAmbientColor 1010
...
#define FN_getMaterialFlag 1045
...
#define FN_setMaterialTexture 1046
...
#define FN_setMaterialShininess 1047
...
#define FN_getActorMaterialFlag 1058
...
#define FN_setActorMaterialType 1059
...
#define FN_getActorMaterialType 1060
...
#define FN_SetMaterialConstant 1064
...
#define FN_GetMaterialConstant 1065
