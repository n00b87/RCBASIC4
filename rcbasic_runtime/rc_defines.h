...
#define FN_GetLineAngle 55
#define GETLINEANGLE_X1 num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define GETLINEANGLE_Y1 num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define GETLINEANGLE_X2 num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define GETLINEANGLE_Y2 num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define FN_DotProduct 56
#define DOTPRODUCT_X1 num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define DOTPRODUCT_Y1 num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define DOTPRODUCT_Z1 num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define DOTPRODUCT_X2 num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define DOTPRODUCT_Y2 num_var[4].nref[0].value[ num_var[4].byref_offset ]
#define DOTPRODUCT_Z2 num_var[5].nref[0].value[ num_var[5].byref_offset ]
#define FN_InterpolateVector 57
#define INTERPOLATEVECTOR_X1 num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define INTERPOLATEVECTOR_Y1 num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define INTERPOLATEVECTOR_Z1 num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define INTERPOLATEVECTOR_X2 num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define INTERPOLATEVECTOR_Y2 num_var[4].nref[0].value[ num_var[4].byref_offset ]
#define INTERPOLATEVECTOR_Z2 num_var[5].nref[0].value[ num_var[5].byref_offset ]
#define INTERPOLATEVECTOR_DISTANCE num_var[6].nref[0].value[ num_var[6].byref_offset ]
#define INTERPOLATEVECTOR_IX num_var[7].nref[0].value[ num_var[7].byref_offset ]
#define INTERPOLATEVECTOR_IY num_var[8].nref[0].value[ num_var[8].byref_offset ]
#define INTERPOLATEVECTOR_IZ num_var[9].nref[0].value[ num_var[9].byref_offset ]
#define FN_InterpolateVectorQ 58
#define INTERPOLATEVECTORQ_X1 num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define INTERPOLATEVECTORQ_Y1 num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define INTERPOLATEVECTORQ_Z1 num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define INTERPOLATEVECTORQ_X2 num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define INTERPOLATEVECTORQ_Y2 num_var[4].nref[0].value[ num_var[4].byref_offset ]
#define INTERPOLATEVECTORQ_Z2 num_var[5].nref[0].value[ num_var[5].byref_offset ]
#define INTERPOLATEVECTORQ_X3 num_var[6].nref[0].value[ num_var[6].byref_offset ]
#define INTERPOLATEVECTORQ_Y3 num_var[7].nref[0].value[ num_var[7].byref_offset ]
#define INTERPOLATEVECTORQ_Z3 num_var[8].nref[0].value[ num_var[8].byref_offset ]
#define INTERPOLATEVECTORQ_DISTANCE num_var[9].nref[0].value[ num_var[9].byref_offset ]
#define INTERPOLATEVECTORQ_IX num_var[10].nref[0].value[ num_var[10].byref_offset ]
#define INTERPOLATEVECTORQ_IY num_var[11].nref[0].value[ num_var[11].byref_offset ]
#define INTERPOLATEVECTORQ_IZ num_var[12].nref[0].value[ num_var[12].byref_offset ]
#define FN_VectorIsBetweenPoints 59
#define VECTORISBETWEENPOINTS_X num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define VECTORISBETWEENPOINTS_Y num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define VECTORISBETWEENPOINTS_Z num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define VECTORISBETWEENPOINTS_START_X num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define VECTORISBETWEENPOINTS_START_Y num_var[4].nref[0].value[ num_var[4].byref_offset ]
#define VECTORISBETWEENPOINTS_START_Z num_var[5].nref[0].value[ num_var[5].byref_offset ]
#define VECTORISBETWEENPOINTS_END_X num_var[6].nref[0].value[ num_var[6].byref_offset ]
#define VECTORISBETWEENPOINTS_END_Y num_var[7].nref[0].value[ num_var[7].byref_offset ]
#define VECTORISBETWEENPOINTS_END_Z num_var[8].nref[0].value[ num_var[8].byref_offset ]
#define FN_NormalizeVector 60
#define NORMALIZEVECTOR_X num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define NORMALIZEVECTOR_Y num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define NORMALIZEVECTOR_Z num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define NORMALIZEVECTOR_NX num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define NORMALIZEVECTOR_NY num_var[4].nref[0].value[ num_var[4].byref_offset ]
#define NORMALIZEVECTOR_NZ num_var[5].nref[0].value[ num_var[5].byref_offset ]
#define FN_GetHorizontalAngle 61
#define GETHORIZONTALANGLE_X num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define GETHORIZONTALANGLE_Y num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define GETHORIZONTALANGLE_Z num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define GETHORIZONTALANGLE_HX num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define GETHORIZONTALANGLE_HY num_var[4].nref[0].value[ num_var[4].byref_offset ]
#define GETHORIZONTALANGLE_HZ num_var[5].nref[0].value[ num_var[5].byref_offset ]
#define FN_GetRotationToTarget 62
#define GETROTATIONTOTARGET_X num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define GETROTATIONTOTARGET_Y num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define GETROTATIONTOTARGET_Z num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define GETROTATIONTOTARGET_TGT_X num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define GETROTATIONTOTARGET_TGT_Y num_var[4].nref[0].value[ num_var[4].byref_offset ]
#define GETROTATIONTOTARGET_TGT_Z num_var[5].nref[0].value[ num_var[5].byref_offset ]
#define GETROTATIONTOTARGET_RX num_var[6].nref[0].value[ num_var[6].byref_offset ]
#define GETROTATIONTOTARGET_RY num_var[7].nref[0].value[ num_var[7].byref_offset ]
#define GETROTATIONTOTARGET_RZ num_var[8].nref[0].value[ num_var[8].byref_offset ]
#define FN_Asc 63
...
#define FN_CloseWindow 136
#define FN_RaiseWindow 137
#define FN_Update 138
#define FN_Cls 139
#define FN_SetClearColor 140
#define SETCLEARCOLOR_C num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_ShowWindow 141
#define FN_HideWindow 142
#define FN_SetWindowTitle 143
#define SETWINDOWTITLE_TITLE$ str_var[0].sref[0].value[ str_var[0].byref_offset ]
#define FN_WindowTitle$ 144
#define FN_SetWindowPosition 145
...
#define FN_GetWindowPosition 146
...
#define FN_SetWindowMinSize 149
...
#define FN_GetWindowMinSize 150
...
#define FN_SetWindowMaxSize 151
...
#define FN_GetWindowMaxSize 152
...
#define FN_WindowIsFullscreen 153
#define FN_WindowIsVisible 154
#define FN_WindowIsBordered 155
#define FN_WindowIsResizable 156
#define FN_WindowIsMinimized 157
#define FN_WindowIsMaximized 158
#define FN_WindowHasInputFocus 159
#define FN_WindowHasMouseFocus 160
#define FN_SetWindowFullscreen 161
#define SETWINDOWFULLSCREEN_FLAG num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_MaximizeWindow 162
#define FN_MinimizeWindow 163
#define FN_SetWindowBordered 164
#define SETWINDOWBORDERED_FLAG num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_WindowClip 165
...
#define FN_WindowExists 166
#define FN_WindowEvent_Close 167
#define FN_WindowEvent_Maximize 168
#define FN_WindowEvent_Minimize 169
#define FN_FPS 170
#define FN_SetWindowIcon 171
#define SETWINDOWICON_SLOT num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_WindowEvent_Resize 172
#define FN_SetWindowAutoClose 173
#define SETWINDOWAUTOCLOSE_EXIT_ON_CLOSE num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetWindowResizable 174
#define SETWINDOWRESIZABLE_FLAG num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_WindowMode 175
...
#define FN_SetCanvasVisible 189
...
#define FN_GetCanvasViewport 192
...
#define FN_ClearCanvas 197
#define FN_SetCanvasAlpha 198
...
#define FN_ActiveCanvas 206
#define FN_SetCanvasPhysics2D 207
...
#define FN_OpenCanvasSpriteLayer 208
...
#define FN_SetSpriteCanvasBlendMode 209
...
#define FN_GetSpriteCanvasRenderPriority 217
...
#define FN_GetPostEffectProperty 221
...
#define FN_SetPostEffectActive 222
...
#define FN_PostEffectIsActive 223
#define POSTEFFECTISACTIVE_C_NUM num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetPostEffectType 224
#define GETPOSTEFFECTTYPE_C_NUM num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetCanvasBackgroundRender 225
#define SETCANVASBACKGROUNDRENDER_C_NUM num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETCANVASBACKGROUNDRENDER_FLAG num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define FN_Circle 226
...
#define FN_SetBlendMode 259
#define SETBLENDMODE_BLEND_MODE num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetBlendMode 260
#define FN_SetImageColorMod 261
...
#define FN_DrawImage_BlitEx 265
...
#define FN_DrawImage_Rotate 266
...
#define FN_DrawImage_RotateEx 267
...
#define FN_DrawImage_ZoomEx 269
...
#define FN_DrawImage_Rotozoom 270
...
#define FN_DrawImage_RotozoomEx 271
...
#define FN_DrawImage_FlipEx 273
...
#define FN_SetAntiAliasMode 275
#define SETANTIALIASMODE_AA_MODE num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetAntiAliasMode 276
#define FN_ConvertToNormalMap 277
...
#define FN_WaitKey 280
#define FN_HideMouse 281
#define FN_ShowMouse 282
#define FN_MouseIsVisible 283
#define FN_GetMouse 284
...
#define FN_MouseX 285
#define FN_MouseY 286
#define FN_MouseButton 287
#define MOUSEBUTTON_MB num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetMouseWheel 288
...
#define FN_MouseWheelX 289
#define FN_MouseWheelY 290
#define FN_GetGlobalMouse 291
...
#define FN_GlobalMouseX 292
#define FN_GlobalMouseY 293
#define FN_WarpMouse 294
...
#define FN_ClearMouseZone 297
#define FN_CreateSound 298
...
#define FN_SetChannelDistance 329
...
#define FN_MusicIsPlaying 333
#define FN_SetChannelSpacePosition 334
...
#define FN_NumFingers 362
#define FN_GetAccel 363
...
#define FN_LoadVideo 389
#define LOADVIDEO_VID$ str_var[0].sref[0].value[ str_var[0].byref_offset ]
#define FN_PlayVideo 390
#define PLAYVIDEO_VLOOPS num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_PauseVideo 391
#define FN_StopVideo 392
#define FN_SetVideoPosition 393
#define SETVIDEOPOSITION_POS num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_ResumeVideo 394
#define FN_GetVideoPosition 395
#define FN_DeleteVideo 396
#define FN_VideoIsPlaying 397
#define FN_VideoEnd 398
#define FN_GetVideoStats 399
...
#define FN_SetVideoDrawRect 400
...
#define FN_GetVideoDrawRect 401
...
#define FN_Android_GetExternalStoragePath$ 413
#define FN_Android_GetExternalStorageState 414
#define FN_Android_GetInternalStoragePath$ 415
#define FN_Android_JNI_Message$ 416
#define ANDROID_JNI_MESSAGE$_ARG$ str_var[0].sref[0].value[ str_var[0].byref_offset ]
#define FN_Runtime_Utility_Message$ 417
#define RUNTIME_UTILITY_MESSAGE$_ARG$ str_var[0].sref[0].value[ str_var[0].byref_offset ]
#define FN_GetDesktopDisplayMode 418
...
#define FN_Runtime$ 424
#define FN_NumCPUs 425
#define FN_SystemRam 426
#define FN_GetGPUInfo$ 427
#define FN_Steam_AddAchievement 428
...
#define FN_Steam_ClearAchievements 429
#define FN_Steam_FinalizeAchievements 430
#define FN_Steam_TriggerAchievement 431
#define STEAM_TRIGGERACHIEVEMENT_ACH_NAME$ str_var[0].sref[0].value[ str_var[0].byref_offset ]
#define FN_Steam_GetID$ 432
#define FN_DimMatrix 433
...
#define FN_InsertMatrixColumns 438
...
#define FN_InsertMatrixRows 439
...
#define FN_DeleteMatrixColumns 442
...
#define FN_DeleteMatrixRows 443
...
#define FN_FillMatrixColumns 448
...
#define FN_CopyMatrixColumns 450
...
#define FN_SetIdentityMatrix 452
...
#define FN_MatrixFromBuffer 458
...
#define FN_BufferFromMatrix 459
...
#define FN_ScalarMatrixColumns 464
...
#define FN_ScalarMatrixRows 465
...
#define FN_SwapMatrixColumn 470
...
#define FN_IncrementMatrixRows 476
...
#define FN_IncrementMatrixColumns 477
...
#define FN_JoinMatrixColumns 479
...
#define FN_SetMatrixTranslation 481
...
#define FN_SetMatrixRotation 482
...
#define FN_GetMatrixTranslation 484
...
#define FN_GetMatrixRotation 485
...
#define FN_MatrixExists 487
#define MATRIXEXISTS_MA num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetClipboardText$ 488
#define FN_SetClipboardText 489
#define SETCLIPBOARDTEXT_TXT$ str_var[0].sref[0].value[ str_var[0].byref_offset ]
#define FN_HasClipboardText 490
#define FN_ReadInput_Start 491
#define FN_ReadInput_Stop 492
#define FN_ReadInput_GetText$ 493
#define FN_ReadInput_SetText 494
#define READINPUT_SETTEXT_TXT$ str_var[0].sref[0].value[ str_var[0].byref_offset ]
#define FN_ReadInput_ToggleBackspace 495
#define READINPUT_TOGGLEBACKSPACE_FLAG num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_CreateSprite 496
...
#define FN_GetSpritePosition 500
...
#define FN_RemoveSpriteChild 528
...
#define FN_GetSpriteChildIndex 529
...
#define FN_GetSpriteCollision 530
#define GETSPRITECOLLISION_SPRITEA num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define GETSPRITECOLLISION_SPRITEB num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define FN_CreateSpriteAnimation 531
...
#define FN_GetSpriteAnimationFrame 535
...
#define FN_SetSpriteAnimationLength 536
...
#define FN_GetSpriteAnimationLength 537
...
#define FN_SetSpriteAnimationSpeed 538
...
#define FN_GetSpriteAnimationSpeed 539
...
#define FN_SetSpriteAnimation 540
...
#define FN_GetSpriteAnimationSource 546
...
#define FN_setSpriteLinearVelocity 548
...
#define FN_getSpriteLinearVelocity 549
...
#define FN_setSpriteAngularVelocity 550
...
#define FN_applySpriteCentralForce 553
...
#define FN_applySpriteTorque 554
...
#define FN_applySpriteLinearImpulse 555
...
#define FN_applySpriteAngularImpulse 556
...
#define FN_getSpriteWorldVector 560
...
#define FN_getSpriteLocalPoint 561
...
#define FN_getSpriteLocalVector 562
...
#define FN_getSpriteLinearVelocityFromLocalPoint 563
...
#define FN_getSpriteLinearVelocityFromWorldPoint 564
...
#define FN_SetWorld2DTimeStep 590
#define SETWORLD2DTIMESTEP_TS num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetWorld2DVelocityIterations 591
#define SETWORLD2DVELOCITYITERATIONS_V num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetWorld2DPositionIterations 592
#define SETWORLD2DPOSITIONITERATIONS_P num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetWorld2DTimeStep 593
#define FN_GetWorld2DVelocityIterations 594
#define FN_GetWorld2DPositionIterations 595
#define FN_SetWorld2DAutoClearForces 596
#define SETWORLD2DAUTOCLEARFORCES_FLAG num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetWorld2DAutoClearForces 597
#define FN_CastRay2D 598
...
#define FN_GetSpriteBoxSize 606
...
#define FN_SetSpriteChainLoop 608
...
#define FN_SetSpritePolygon 609
...
#define FN_SetSpriteShapeOffset 610
...
#define FN_GetSpriteShapeOffset 611
...
#define FN_GetSpriteWorldCenter 612
...
#define FN_createDistanceJoint 613
...
#define FN_createFrictionJoint 614
...
#define FN_createMotorJoint 616
...
#define FN_createPrismaticJoint 617
...
#define FN_createPulleyJoint 618
...
#define FN_createRevoluteJoint 619
...
#define FN_createWheelJoint 621
...
#define FN_getJointWorldAnchorA 622
...
#define FN_getJointWorldAnchorB 623
...
#define FN_getJointReactionForce 624
...
#define FN_getJointReactionTorque 625
...
#define FN_getJointLocalAnchorA 626
...
#define FN_getJointLocalAnchorB 627
...
#define FN_getJointLinearOffset 648
...
#define FN_setJointAngularOffset 649
...
#define FN_setJointMotorSpeed 662
...
#define FN_setJointMaxMotorTorque 667
...
#define FN_getJointGroundAnchorA 670
...
#define FN_getJointGroundAnchorB 671
...
#define FN_SetTileAnimationLength 683
...
#define FN_GetTileAnimationLength 684
...
#define FN_SetTileAnimationFrame 685
...
#define FN_GetTileAnimationFrame 686
...
#define FN_SetTileAnimationSpeed 687
...
#define FN_GetTileAnimationSpeed 688
...
#define FN_LoadMeshFromArchive 704
...
#define FN_CreateCylinderMesh 711
...
#define FN_CreateVolumeLightMesh 712
...
#define FN_GetMeshBoundingBox 715
...
#define FN_GetMeshBufferIndexCount 724
...
#define FN_SetActorPosition 741
...
#define FN_TranslateActorLocal 742
...
#define FN_TranslateActorWorld 743
...
#define FN_GetActorPosition 744
...
#define FN_SetActorRotation 748
...
#define FN_GetActorRotation 750
...
#define FN_SetActorAnimation 761
...
#define FN_SetActorAnimationSpeed 762
...
#define FN_SetActorAnimationFrames 763
...
#define FN_GetActorAnimationStartFrame 766
...
#define FN_GetActorAnimationEndFrame 767
...
#define FN_SetActorMD2AnimationByName 777
...
#define FN_DeleteActorAnimation 778
...
#define FN_GetActorBoneName$ 781
...
#define FN_GetActorBonePosition 782
...
#define FN_GetActorBoneRotation 783
...
#define FN_GetActorBoneScale 784
...
#define FN_GetActorBoneRelativeTranform 785
...
#define FN_GetActorBoneAbsoluteTranform 786
...
#define FN_UpdateActorAnimation 787
#define UPDATEACTORANIMATION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetGravity3D 788
...
#define FN_setActorMassProperties 803
...
#define FN_getActorLinearFactor 804
...
#define FN_setActorLinearFactor 805
...
#define FN_applyActorCentralForceLocal 808
...
#define FN_applyActorCentralForceWorld 809
...
#define FN_getActorTotalForce 810
...
#define FN_getActorTotalTorque 811
...
#define FN_getActorInverseInertiaDiagLocal 812
...
#define FN_setActorInverseInertiaDiagLocal 813
...
#define FN_setActorSleepThresholds 814
...
#define FN_applyActorTorqueLocal 815
...
#define FN_applyActorTorqueWorld 816
...
#define FN_applyActorForceLocal 817
...
#define FN_applyActorForceWorld 818
...
#define FN_applyActorCentralImpulseLocal 819
...
#define FN_applyActorCentralImpulseWorld 820
...
#define FN_applyActorTorqueImpulseLocal 821
...
#define FN_applyActorTorqueImpulseWorld 822
...
#define FN_applyActorImpulseLocal 823
...
#define FN_applyActorImpulseWorld 824
...
#define FN_getActorRotationQ 828
...
#define FN_getActorLinearVelocityWorld 829
...
#define FN_getActorAngularVelocityWorld 830
...
#define FN_setActorLinearVelocityLocal 831
...
#define FN_setActorLinearVelocityWorld 832
...
#define FN_setActorAngularVelocityLocal 833
...
#define FN_setActorAngularVelocityWorld 834
...
#define FN_getActorVelocityInLocalPoint 835
...
#define FN_getActorLinearVelocityLocal 836
...
#define FN_getActorAngularVelocityLocal 837
...
#define FN_computeActorImpulseDenominator 839
...
#define FN_computeActorAngularImpulseDenominator 840
...
#define FN_setActorAngularFactor 841
...
#define FN_getActorAngularFactor 842
...
#define FN_computeActorGyroImpulseLocal 843
...
#define FN_computeActorGyroImpulseWorld 844
...
#define FN_getActorLocalInertia 845
...
#define FN_SetActorSleepState 846
...
#define FN_SetActorImpactMesh 851
...
#define FN_GetActorTurnVelocity 852
#define GETACTORTURNVELOCITY_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define GETACTORTURNVELOCITY_X num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define GETACTORTURNVELOCITY_Y num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define GETACTORTURNVELOCITY_Z num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define FN_SetActorTurnVelocity 853
#define SETACTORTURNVELOCITY_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETACTORTURNVELOCITY_X num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define SETACTORTURNVELOCITY_Y num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define SETACTORTURNVELOCITY_Z num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define FN_GetActorFriction 854
#define GETACTORFRICTION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetActorFriction 855
#define SETACTORFRICTION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETACTORFRICTION_FRICTION num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define FN_ActorHasAniFriction 856
#define ACTORHASANIFRICTION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetActorAniFriction 857
#define GETACTORANIFRICTION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define GETACTORANIFRICTION_X num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define GETACTORANIFRICTION_Y num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define GETACTORANIFRICTION_Z num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define FN_SetActorAniFriction 858
#define SETACTORANIFRICTION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETACTORANIFRICTION_X num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define SETACTORANIFRICTION_Y num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define SETACTORANIFRICTION_Z num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define FN_GetActorRollingFriction 859
#define GETACTORROLLINGFRICTION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetActorRollingFriction 860
#define SETACTORROLLINGFRICTION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETACTORROLLINGFRICTION_FRICTION num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define FN_GetActorSpinningFriction 861
#define GETACTORSPINNINGFRICTION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetActorSpinningFriction 862
#define SETACTORSPINNINGFRICTION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETACTORSPINNINGFRICTION_FRICTION num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define FN_GetActorContactProcessingThreshold 863
#define GETACTORCONTACTPROCESSINGTHRESHOLD_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetActorContactProcessingThreshold 864
#define SETACTORCONTACTPROCESSINGTHRESHOLD_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETACTORCONTACTPROCESSINGTHRESHOLD_CPT num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define FN_GetActorHitFraction 865
#define GETACTORHITFRACTION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetActorHitFraction 866
#define SETACTORHITFRACTION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETACTORHITFRACTION_HIT_FRACTION num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define FN_GetActorInterpolationAngularVelocity 867
#define GETACTORINTERPOLATIONANGULARVELOCITY_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define GETACTORINTERPOLATIONANGULARVELOCITY_X num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define GETACTORINTERPOLATIONANGULARVELOCITY_Y num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define GETACTORINTERPOLATIONANGULARVELOCITY_Z num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define FN_SetActorInterpolationAngularVelocity 868
#define SETACTORINTERPOLATIONANGULARVELOCITY_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETACTORINTERPOLATIONANGULARVELOCITY_X num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define SETACTORINTERPOLATIONANGULARVELOCITY_Y num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define SETACTORINTERPOLATIONANGULARVELOCITY_Z num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define FN_GetActorInterpolationLinearVelocity 869
#define GETACTORINTERPOLATIONLINEARVELOCITY_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define GETACTORINTERPOLATIONLINEARVELOCITY_X num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define GETACTORINTERPOLATIONLINEARVELOCITY_Y num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define GETACTORINTERPOLATIONLINEARVELOCITY_Z num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define FN_SetActorInterpolationLinearVelocity 870
#define SETACTORINTERPOLATIONLINEARVELOCITY_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETACTORINTERPOLATIONLINEARVELOCITY_X num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define SETACTORINTERPOLATIONLINEARVELOCITY_Y num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define SETACTORINTERPOLATIONLINEARVELOCITY_Z num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define FN_GetActorConstraintRefCount 871
#define GETACTORCONSTRAINTREFCOUNT_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetActorRestitution 872
#define GETACTORRESTITUTION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetActorRestitution 873
#define SETACTORRESTITUTION_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETACTORRESTITUTION_REST num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define FN_GetActorCcdMotionThreshold 874
#define GETACTORCCDMOTIONTHRESHOLD_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetActorCCDSquareMotionThreshold 875
#define GETACTORCCDSQUAREMOTIONTHRESHOLD_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetActorCCDSweepRadius 876
#define GETACTORCCDSWEEPRADIUS_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetActorCCD 877
#define SETACTORCCD_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETACTORCCD_M_THRESHOLD num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define SETACTORCCD_RADIUS num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define FN_SetActorContactStiffnessAndDamping 878
#define SETACTORCONTACTSTIFFNESSANDDAMPING_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETACTORCONTACTSTIFFNESSANDDAMPING_STIFFNESS num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define SETACTORCONTACTSTIFFNESSANDDAMPING_DAMPING num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define FN_GetActorContactDamping 879
#define GETACTORCONTACTDAMPING_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetActorContactStiffness 880
#define GETACTORCONTACTSTIFFNESS_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetActorPushVelocity 881
#define GETACTORPUSHVELOCITY_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define GETACTORPUSHVELOCITY_X num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define GETACTORPUSHVELOCITY_Y num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define GETACTORPUSHVELOCITY_Z num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define FN_GetActorPushVelocityInLocalPoint 882
#define GETACTORPUSHVELOCITYINLOCALPOINT_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define GETACTORPUSHVELOCITYINLOCALPOINT_REL_X num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define GETACTORPUSHVELOCITYINLOCALPOINT_REL_Y num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define GETACTORPUSHVELOCITYINLOCALPOINT_REL_Z num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define GETACTORPUSHVELOCITYINLOCALPOINT_X num_var[4].nref[0].value[ num_var[4].byref_offset ]
#define GETACTORPUSHVELOCITYINLOCALPOINT_Y num_var[5].nref[0].value[ num_var[5].byref_offset ]
#define GETACTORPUSHVELOCITYINLOCALPOINT_Z num_var[6].nref[0].value[ num_var[6].byref_offset ]
#define FN_SetActorPushVelocity 883
#define SETACTORPUSHVELOCITY_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETACTORPUSHVELOCITY_X num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define SETACTORPUSHVELOCITY_Y num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define SETACTORPUSHVELOCITY_Z num_var[3].nref[0].value[ num_var[3].byref_offset ]
#define FN_createPointConstraint 884
...
#define FN_createPointConstraintEx 885
...
#define FN_createHingeConstraint 888
...
#define FN_createHingeConstraintEx 889
...
#define FN_createSlideConstraint 890
...
#define FN_createSlideConstraintEx 891
...
#define FN_createConeConstraint 892
...
#define FN_createConeConstraintEx 893
...
#define FN_getConstraintFrameOffsetB 896
...
#define FN_useConstraintFrameOffset 897
...
#define FN_getConstraintBFrame 902
...
#define FN_setConstraintBreakingImpulseThreshold 904
...
#define FN_setConstraintFrames 905
...
#define FN_setConeFixThresh 937
...
#define FN_setSlideDampingDirLin 970
...
#define FN_setSlideDampingLimAng 971
...
#define FN_setSlideDampingLimLin 972
...
#define FN_setSlideDampingOrthoAng 973
...
#define FN_setSlideDampingOrthoLin 974
...
#define FN_setSlideLowerAngLimit 975
...
#define FN_setSlideLowerLinLimit 976
...
#define FN_setSlideRestitutionDirAng 977
...
#define FN_setSlideRestitutionDirLin 978
...
#define FN_setSlideRestitutionLimAng 979
...
#define FN_setSlideRestitutionLimLin 980
...
#define FN_setSlideRestitutionOrthoAng 981
...
#define FN_setSlideRestitutionOrthoLin 982
...
#define FN_setSlideSoftnessDirAng 983
...
#define FN_setSlideSoftnessDirLin 984
...
#define FN_setSlideSoftnessLimAng 985
...
#define FN_setSlideSoftnessLimLin 986
...
#define FN_setSlideSoftnessOrthoAng 987
...
#define FN_setSlideSoftnessOrthoLin 988
...
#define FN_setSlideUpperAngLimit 989
...
#define FN_setSlideUpperLinLimit 990
...
#define FN_GetCameraPosition 993
...
#define FN_SetCameraRotation 995
...
#define FN_GetCameraRotation 996
...
#define FN_RemoveSceneSky 1012
#define FN_SetWorld3DMaxSubSteps 1013
#define SETWORLD3DMAXSUBSTEPS_STEPS num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_SetWorld3DTimeStep 1014
#define SETWORLD3DTIMESTEP_TS num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetWorld3DMaxSubSteps 1015
#define FN_GetWorld3DTimeStep 1016
#define FN_SetSceneFog 1017
...
#define FN_ClearScene 1019
#define FN_SetSceneShadowColor 1020
#define SETSCENESHADOWCOLOR_COLOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetSceneShadowColor 1021
#define FN_SetSceneAmbientColor 1022
#define SETSCENEAMBIENTCOLOR_COLOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetSceneAmbientColor 1023
#define FN_Pipeline_Begin 1024
#define FN_Pipeline_End 1025
#define FN_Pipeline_Render 1026
#define FN_SetPhysics3D 1027
#define SETPHYSICS3D_FLAG num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_GetPhysics3D 1028
#define FN_GetBillboardSize 1029
#define GETBILLBOARDSIZE_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define GETBILLBOARDSIZE_W num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define GETBILLBOARDSIZE_H num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define FN_SetBillboardSize 1030
#define SETBILLBOARDSIZE_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define SETBILLBOARDSIZE_W num_var[1].nref[0].value[ num_var[1].byref_offset ]
#define SETBILLBOARDSIZE_H num_var[2].nref[0].value[ num_var[2].byref_offset ]
#define FN_startParticleEmitter 1031
#define STARTPARTICLEEMITTER_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_stopParticleEmitter 1032
#define STOPPARTICLEEMITTER_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_setParticleDirection 1033
...
#define FN_getParticleDirection 1034
...
#define FN_useParticleEveryMeshVertex 1035
...
#define FN_particleIsUsingEveryMeshVertex 1036
#define PARTICLEISUSINGEVERYMESHVERTEX_ACTOR num_var[0].nref[0].value[ num_var[0].byref_offset ]
#define FN_setParticleNormalDirectionMod 1037
...
#define FN_setMinParticlesPerSecond 1042
...
#define FN_getParticleMinStartSize 1057
...
#define FN_setParticleMaxStartSize 1058
...
#define FN_getParticleMaxStartSize 1059
...
#define FN_setParticleCenter 1060
...
#define FN_getParticleCenter 1061
...
#define FN_setParticleRadius 1062
...
#define FN_setParticleNormal 1068
...
#define FN_getParticleNormal 1069
...
#define FN_setParticleLength 1070
...
#define FN_setLightShadowCast 1080
...
#define FN_SetLightAmbientColor 1081
...
#define FN_GetLightAttenuation 1084
...
#define FN_SetLightDiffuseColor 1085
...
#define FN_GetTerrainPatchLOD 1096
...
#define FN_GetTerrainHeight 1097
...
#define FN_GetTerrainCenter 1098
...
#define FN_SetTerrainLODDistance 1099
...
#define FN_ScaleTerrainTexture 1100
...
#define FN_SetTerrainCameraMovementDelta 1101
...
#define FN_SetTerrainCameraRotationDelta 1102
...
#define FN_SetTerrainPatchLOD 1103
...
#define FN_SetProjectorTarget 1104
...
#define FN_GetProjectorTarget 1105
...
#define FN_SetProjectorFOV 1106
...
#define FN_RemoveProjectorEffectActor 1113
...
#define FN_AddCompositeChild 1114
...
#define FN_GetCompositeChildIndex 1117
...
#define FN_RemoveCompositeChild 1118
...
#define FN_GetCompositeChildTransform 1119
...
#define FN_GetCompositeAABB 1120
...
#define FN_UpdateCompositeChildTransform 1124
...
#define FN_GetVehicleForwardVector 1128
...
#define FN_GetWheelSteeringValue 1132
...
#define FN_GetWheelWorldTransform 1133
...
#define FN_GetWheelConnectionPoint 1134
...
#define FN_GetWheelDirection 1135
...
#define FN_GetWheelSuspensionLength 1137
...
#define FN_GetWheelMaxSuspensionTravel 1138
...
#define FN_GetWheelSuspensionStiffness 1140
...
#define FN_GetWheelDampingCompression 1141
...
#define FN_GetWheelDampingRelaxation 1142
...
#define FN_GetWheelFrictionSlip 1143
...
#define FN_GetWheelRotation 1144
...
#define FN_GetWheelRotationDelta 1145
...
#define FN_GetWheelRollInfluence 1146
...
#define FN_GetWheelEngineForce 1147
...
#define FN_GetWheelInverseContactSuspension 1150
...
#define FN_GetWheelSuspensionVelocity 1151
...
#define FN_ApplyWheelEngineForce 1154
...
#define FN_SetVehiclePitchControl 1156
...
#define FN_SetWheelConnectionPoint 1157
...
#define FN_SetWheelDirection 1158
...
#define FN_SetWheelSuspensionLength 1160
...
#define FN_SetWheelMaxSuspensionTravel 1161
...
#define FN_SetWheelSuspensionStiffness 1163
...
#define FN_SetWheelDampingCompression 1164
...
#define FN_SetWheelDampingRelaxation 1165
...
#define FN_SetWheelFrictionSlip 1166
...
#define FN_SetWheelRotation 1167
...
#define FN_SetWheelRollInfluence 1168
...
#define FN_SetWheelInverseContactSuspension 1169
...
#define FN_SetWheelSuspensionVelocity 1170
...
#define FN_SetWheelActorOffsetTransform 1171
...
#define FN_GetWheelActorOffsetTransform 1172
...
#define FN_getActorMaterial 1177
...
#define FN_copyActorMaterial 1178
...
#define FN_setMaterialAmbientColor 1181
...
#define FN_getMaterialFlag 1216
...
#define FN_setMaterialTexture 1217
...
#define FN_setMaterialShininess 1218
...
#define FN_getActorMaterialFlag 1229
...
#define FN_setActorMaterialType 1230
...
#define FN_getActorMaterialType 1231
...
#define FN_SetMaterialConstant 1235
...
#define FN_GetMaterialConstant 1236
